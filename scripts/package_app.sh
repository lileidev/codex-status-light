...
# Brand logos rendered as agent glyphs (Claude app icon, DeepSeek whale, OpenAI mark).
cp "$project_root/Sources/AgentsLight/Resources/claude-logo.png" "$destination/Contents/Resources/claude-logo.png"
